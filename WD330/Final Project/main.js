/**
// Function to add degree symbol to weather preview in menu sidebar.
function initialize() {
    // Append degree symbol to number.
    let tempSB = document.getElementById("weatherSidebarTemp");
    let degree = '\u00B0';
    var degreeSymbol = document.createElement("span");
    

    degreeSymbol.innerText = degree;
    tempSB.appendChild(degreeSymbol);
